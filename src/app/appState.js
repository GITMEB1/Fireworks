export function createAppState(overrides = {}) {
  ...
  return {
    ...
    fpsSamples: [],
    reducedMotion,
    runtimeProfileId: overrides.runtimeProfileId || 'desktop-default',
    runtimeProfileLabel: overrides.runtimeProfileLabel || 'Desktop Default',
    runtimeProfileMeta: overrides.runtimeProfileMeta || {},
    displayDprCap: overrides.displayDprCap ?? 2,

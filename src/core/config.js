export const CONFIG = {
  ...
  OBJECTIVE: {
    ...
    scoreDirectHitBonus: 14,
    scoreCriticalFinishBonus: 45,
    pressureRecoveryCriticalBonus: 4,
    targetFractureThreshold: 0.46,
    targetShatterThreshold: 0.98,
    targetCriticalShatterThreshold: 0.72,
    targetShatterDirectBonus: 0.14,
    targetShatterCriticalBonus: 0.15,
    targetShatterBaseFragments: 2,
    targetShatterPriorityFragments: 1,
    targetShatterArmoredFragments: 1,
    targetShatterMaxFragments: 6,
    targetFragmentMaxConcurrent: 24,
    targetFragmentLifetimeMs: 1180,
    targetFragmentLifetimeJitterMs: 360,
    targetFragmentDrag: 0.958,
    targetFragmentGravityMult: 0.96,
    targetFragmentSpinMax: 0.14,
    scoreShatterBonus: 34
  },
